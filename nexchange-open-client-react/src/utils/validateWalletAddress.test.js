...
describe('Validate coin address', () => {
  ...
  it('validates valid HTH address', () => {
    expect(validateWalletAddress('HNbhe1Pfm2eH8d5NthFTzEZNwdzDJFKw6V', 'HTH')).toEqual(true);
  });
  
  it('invalidates invalid HTH address', () => {
    expect(validateWalletAddress('random address', 'HTH')).toEqual(false);
